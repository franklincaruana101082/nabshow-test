(function($){
	...
	function initialize_field( $el ) {
		...
		$('.acf-random-string-field-button').on('click', function(e){
			...
			$(this).parents('.acf-random-string-field-wrap').find('.acf-random-preview-link').text($(this).parents('.acf-random-string-field-wrap').find('.acf-random-preview-link').attr('data-link') + '?addadmin=' + random_string);
			e.preventDefault();
			return false;
		});
