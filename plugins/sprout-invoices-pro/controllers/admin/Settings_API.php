...
class SI_Settings_API extends SI_Controller
{
    ...
    public static function get_input_field($key, $field = array())
    {
        ...
        <input
            ...
            <?php if (isset( $field['option']['required'] ) && $field['option']['required']) {
                echo 'required';
            } ?> />
        <?php
    ...
    public static function get_textarea_field($key, $field = array())
    {
        ...
        <textarea type="textarea" name="<?php echo esc_attr( $key ); ?>"
                  id="<?php echo esc_attr( $key ); ?>"
                  rows="<?php echo isset( $field['option']['rows'] ) ? $field['option']['rows'] : 4; ?>"
                  cols="<?php echo isset( $field['option']['cols'] ) ? $field['option']['cols'] : 40; ?>" <?php echo $attributes ?>><?php echo esc_textarea( $default ); ?></textarea>
        <?php
    ...
    public static function get_checkbox_field($key, $field = array())
    {
        ...
        <label for="<?php echo esc_attr( $key ); ?>" class="si_input_label si_checkbox_label">
            <input type="checkbox" name="<?php echo esc_attr( $key ); ?>" id="<?php echo esc_attr( $key ); ?>"
                   ...
                   value="<?php echo isset( $field['option']['value'] ) ? $field['option']['value'] : 'On'; ?>" <?php echo $attributes ?> <?php if (isset( $field['option']['required'] ) && $field['option']['required']) {
                echo 'required';
    ...
    public static function get_radio_field($key, $field = array())
    {
        ...
        <label for="<?php echo esc_attr( $key ); ?>_<?php esc_attr_e( $option_key ); ?>" class="si_radio_label">
            <input type="radio" name="<?php echo esc_attr( $key ); ?>"
                   ...
                   value="<?php esc_attr_e( $option_key ); ?>" <?php checked( $option_key, $default ) ?> <?php echo $attributes ?>/>&nbsp;<?php echo esc_html( $option_label ); ?>
        </label>
    ...
    public static function get_select_field($key, $field = array())
    {
        ...
        ob_start(); ?>
        <label for="<?php echo esc_attr( $key ); ?>" class="si_input_label"><?php echo $field['label'] ?></label>
        <select type="select" name="<?php echo esc_attr( $key ); ?>"
                id="<?php echo esc_attr( $key ); ?>" <?php echo $attributes ?> <?php if (isset( $field['option']['required'] ) && $field['option']['required']) {
            echo 'required';
        } ?>>
            <?php foreach ($field['option']['options'] as $option_key => $option_label) : ?>
    ...
    public static function get_file_input_field($key, $field = array())
    {
        ...
        <input type="file" name="<?php echo esc_attr( $key ); ?>" id="<?php echo esc_attr( $key ); ?>"
               class="si_input_file"/>
        <label for="<?php echo esc_attr( $key ); ?>"><span><strong><span
                            class="dashicons dashicons-paperclip"></span> <?php _e( 'Choose a file&hellip;', 'sprout-invoices' ) ?></strong></span></label>
        <?php
    ...
    public static function get_hidden_input_field($key, $field = array())
    {
        ...
        <input type="hidden" name="<?php echo esc_attr( $key ); ?>" id="<?php echo esc_attr( $key ); ?>"
               value="<?php echo esc_attr( $field['option']['value'] ); ?>" <?php echo $attributes ?> <?php if (isset( $field['option']['required'] ) && $field['option']['required']) {
            echo 'required';
    ...
    public static function get_multi_file_input_field($key, $field = array())
    {
        ...
        ob_start(); ?>
        <input type="file" name="<?php echo esc_attr( $key ); ?>" id="<?php echo esc_attr( $key ); ?>"
               class="si_input_file" data-multiple-caption="<?php _e( '{count} files selected', 'sprout-invoices' ) ?>"
               multiple/>
        <label for="<?php echo esc_attr( $key ); ?>"><span><strong><span
                            class="dashicons dashicons-paperclip"></span> <?php _e( 'Choose a file&hellip;', 'sprout-invoices' ) ?></strong></span></label>
        <?php
