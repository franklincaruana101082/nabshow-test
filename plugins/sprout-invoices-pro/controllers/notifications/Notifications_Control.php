...
class SI_Notifications_Control extends SI_Controller {
	...
	public static function maybe_refresh_notifications() {
		...
		if ( ! isset( $_GET['reset-notifications'] ) || 'yes' !== $_GET['reset-notifications'] ) {
			return;
		}
		...
		if ( isset( $_GET['delete-extra-notifications'] ) && 'yes' == $_GET['delete-extra-notifications'] ) {

			$active_notifications = get_option( self::NOTIFICATIONS_OPTION_NAME );
			$args['exclude'] = array_values( $active_notifications );
		}
