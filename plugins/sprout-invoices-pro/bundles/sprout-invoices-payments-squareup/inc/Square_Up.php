...
class SA_Square extends SI_Credit_Card_Processors {
	...
	public static function register() {
		...
		add_action( 'si_head', [ __CLASS__, 'si_add_stuff_to_the_header' ], 100 );
	}
	...
	protected function __construct() {
		...
		add_filter( 'sa_credit_card_fields', [ __CLASS__, 'modify_credit_form_fields' ] );
		...
		$settings['payments'] = [
			'si_square_settings' => [
				...
				'settings' => [
					...
					self::API_LOCATION_ID_TEST_OPTION => [
						'label'  => __( 'Location ID', 'sprout-invoices' ),
						'option' => [
							'type'        => 'text',
