...
<div id="si_dashboard" class="wrap about-wrap">
	...
	<div id="si_settings" class="welcome_content clearfix">
		...
		<h1 class="headline_callout"><?php _e( 'Welcome to Sprout Invoices Pro', 'sprout-invoices' ) ?></h1>
		
		<p class="heading_desc"><?php _e( 'Thank you for purchasing the pro version of Sprout Invoices. For those new to Sprout Invoices below is a quick way to register your site, review how SI can help you get paid, and a checklist of items to complete your setup to make things easier.', 'sprout-invoices' ) ?></p>
			...
			<div class="activate_message clearfix">
				...
				<div id="si_activate_wrap">
					...
					<div class="activation_inputs clearfix">
						...
						<span class="input_desc help_block"><?php printf( 'You can find your license on your account page at <a href="%s">sproutinvoices.com</a>', si_get_sa_link( 'https://sproutinvoices.com/account/' ) ) ?></span>
					</div>
					<p>
