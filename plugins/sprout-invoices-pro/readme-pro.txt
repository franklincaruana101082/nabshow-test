...
Thank you for supporting the future of [Sprout Invoices](https://sproutinvoices.com/). I'm trying to build something awesome that you will love. Don't be shy and send me your suggestions.

**Need Support? Go to the [support section at Sprout Invoices](https://sproutinvoices.com/support/).**

== Installation ==

The plugin should already be installed at this point. If you still need help checkout the [support section at Sprout Invoices](https://sproutinvoices.com/support/).
...
* Bug Fix: Fixed issues with Stripe Payments.

= 19.9.2.3 =

* Update: Stripe Payments API updated to be 3D secure compliant
