     ...
     class Woo_MS_Search_licence
        {
            ...
            function licence_key_verify()
                {
                    $license_data = get_site_option('Woo_MS_Search_license');
            ...
            function licence_deactivation_check()
                {
                    ...
                    if ( !  $this->create_lock( 'WOOMSSEARCH__API_status-check', 50 ) )
                        return;
                    ...
                    update_site_option('Woo_MS_Search_license', $license_data);
                    ...
                    $this->release_lock( 'WOOMSSEARCH__API_status-check' );
