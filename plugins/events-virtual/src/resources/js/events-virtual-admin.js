...
( function( $, obj ) {
	...
	obj.showOembedNotice = function( response ) {
		$( obj.selectors.embedNoticeText ).text( response.responseJSON.data );
	 ...
	 * @since 1.0.0
	 */
	obj.handleShowOptionInteractivity = function() {
	...
	obj.bindEvents = function() {
		$( obj.selectors.virtualContainer )
			...
			.on( 'click', obj.selectors.displayOptionCheckbox, obj.handleShowOptionInteractivity );
	};
