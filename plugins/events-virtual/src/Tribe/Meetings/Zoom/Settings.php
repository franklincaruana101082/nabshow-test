	...
	public function add_fields( array $fields = [] ) {
		...
		$zoom_fields = [
			...
			static::$option_prefix . 'client_id'     => [
				'type'            => 'text',
				'label'           => esc_html__( 'Client ID', 'events-virtual' ),
				'tooltip'         => esc_html__( 'Enter the Client ID from your Zoom app.', 'events-virtual' ),
				'validation_type' => 'html',
				'class'           => 'tribe-settings-zoom-application__client-id',
				'attributes'      => $client_id_attrs,
			],
			static::$option_prefix . 'client_secret' => [
				'type'            => 'text',
				'label'           => esc_html__( 'Client Secret', 'events-virtual' ),
				'tooltip'         => esc_html__( 'Enter the Client Secret from your Zoom app. ', 'events-virtual' ),
				'validation_type' => 'html',
				'class'           => 'tribe-settings-zoom-application__client-secret',
				'attributes'      => $client_secret_attrs,
			],
