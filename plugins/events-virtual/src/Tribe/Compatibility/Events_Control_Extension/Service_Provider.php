...
class Service_Provider extends \tad_DI52_ServiceProvider {
	...
	/**
	 * Registers the bindings and filters used to ensure compatibility with the Events Control extnsion.
	 *
	 * @since 1.0.0
	 */
	...
	/**
	 * Redirects requests for Online meta to virtual meta, if set, and viceversa.
	 *
