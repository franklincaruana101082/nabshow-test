...
class Metabox {
	...
	public function update_fields( $post_id, $data ) {
		...
		update_post_meta( $post_id, Event_Meta::$key_rsvp_email_link, Arr::get( $data, 'rsvp-email-link', false ) );
		update_post_meta( $post_id, Event_Meta::$key_ticket_email_link, Arr::get( $data, 'ticket-email-link', false ) );
