	...
	class CTCC_Admin {
		...
		public function closure_render() {
            ...
            <select name='ctcc_options_settings[closure]'>
                <option value='click' <?php selected( $options['closure'], 'click' ); ?>><?php esc_html_e( 'On Click', 'uk-cookie-consent' ); ?></option>
                <option value='scroll' <?php selected( $options['closure'], 'scroll' ); ?>><?php esc_html_e( 'On Scroll', 'uk-cookie-consent' ); ?></option>
                <option value='timed' <?php selected( $options['closure'], 'timed' ); ?>><?php esc_html_e( 'Timed', 'uk-cookie-consent' ); ?></option>

            </select>
            <p class="description"><?php esc_html_e( 'How you want the user to close the notification', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function first_page_render() {
            ...
            <p class="description"><?php esc_html_e( 'Select this to show the notification only on the first page the user visits', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function exclude_zones_render() {
            ...
            <select multiple name='ctcc_options_settings[exclude_zones][]'>
                <option value='AF' <?php selected( in_array( 'AF', $zones, true ) ); ?>><?php esc_html_e( 'Africa', 'uk-cookie-consent' ); ?></option>
                <option value='AN' <?php selected( in_array( 'AN', $zones, true ) ); ?>><?php esc_html_e( 'Antarctica', 'uk-cookie-consent' ); ?></option>
                <option value='AS' <?php selected( in_array( 'AS', $zones, true ) ); ?>><?php esc_html_e( 'Asia', 'uk-cookie-consent' ); ?></option>
                <option value='EU' <?php selected( in_array( 'EU', $zones, true ) ); ?>><?php esc_html_e( 'Europe', 'uk-cookie-consent' ); ?></option>
                <option value='NA' <?php selected( in_array( 'NA', $zones, true ) ); ?>><?php esc_html_e( 'North America', 'uk-cookie-consent' ); ?></option>
                <option value='OC' <?php selected( in_array( 'OC', $zones, true ) ); ?>><?php esc_html_e( 'Oceania', 'uk-cookie-consent' ); ?></option>
                <option value='SA' <?php selected( in_array( 'SA', $zones, true ) ); ?>><?php esc_html_e( 'South America', 'uk-cookie-consent' ); ?></option>
            </select>
            <p class="description"> If you have the <a href="https://wordpress.org/plugins/geoip-detect/" target="_blank">GeoIP Detect</a> plugin activated, you can specify which areas of the world to exclude from displaying the notification.</p>
			<?php
		}
		...
		public function scroll_height_render() {
            ...
            <p class="description"><?php esc_html_e( 'If you chose Scroll as the close method, enter the distance in pixels the user should scroll before the notification closes', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function duration_render() {
            ...
            <p class="description"><?php esc_html_e( 'If you chose Timer as the close method, enter how many seconds the notification should display for', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function cookie_expiry_render() {
            ...
            <p class="description"><?php esc_html_e( 'The number of days that the cookie is set for', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function cookie_version_render() {
            ...
            <p class="description"><?php esc_html_e( 'A version number for the cookie - update this to invalidate the cookie and force all users to view the notification again', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function opt_out_render() {
            ...
            <p class="description"><?php esc_html_e( 'If you previously opted into allowing this plugin to track non-sensitive data, you can opt out here', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function heading_text_render() {
            ...
            <p class="description"><?php esc_html_e( 'The heading text - only applies if you are not using a top or bottom bar', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function notification_text_render() {
            ...
            <p class="description"><?php esc_html_e( 'The default text to indicate that your site uses cookies', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function accept_text_render() {
            ...
            <p class="description"><?php esc_html_e( 'The default text to dismiss the notification', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function more_info_text_render() {
            ...
            <p class="description"><?php esc_html_e( 'The default text to use to link to a page providing further information', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function more_info_page_render() {
			...
			<?php if ( $pages ) { ?>
                ...
                <p class="description"><?php esc_html_e( 'The page containing further information about your cookie policy', 'uk-cookie-consent' ); ?></p>
			<?php }
		}
		...
		public function more_info_url_render() {
            ...
            <p class="description"><?php esc_html_e( 'You can add an absolute URL here to override the More Info Page setting above. Use this to link to an external website for further information about cookies.', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function more_info_target_render() {
            ...
            <select name='ctcc_content_settings[more_info_target]'>
                <option value='_blank' <?php selected( $ctcc_content_settings['more_info_target'], '_blank' ); ?>><?php esc_html_e( 'New Tab', 'uk-cookie-consent' ); ?></option>
                <option value='_self' <?php selected( $ctcc_content_settings['more_info_target'], '_self' ); ?>><?php esc_html_e( 'Same Tab', 'uk-cookie-consent' ); ?></option>
            </select>
            <p class="description"><?php esc_html_e( 'Open the More Information page in the same or new tab.', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function position_render() {
            ...
            <select name='ctcc_styles_settings[position]'>
                <option value='top-bar' <?php selected( $options['position'], 'top-bar' ); ?>><?php esc_html_e( 'Top Bar', 'uk-cookie-consent' ); ?></option>
                <option value='bottom-bar' <?php selected( $options['position'], 'bottom-bar' ); ?>><?php esc_html_e( 'Bottom Bar', 'uk-cookie-consent' ); ?></option>
                <option value='top-left-block' <?php selected( $options['position'], 'top-left-block' ); ?>><?php esc_html_e( 'Top Left Block', 'uk-cookie-consent' ); ?></option>
                <option value='top-right-block' <?php selected( $options['position'], 'top-right-block' ); ?>><?php esc_html_e( 'Top Right Block', 'uk-cookie-consent' ); ?></option>
                <option value='bottom-left-block' <?php selected( $options['position'], 'bottom-left-block' ); ?>><?php esc_html_e( 'Bottom Left Block', 'uk-cookie-consent' ); ?></option>
                <option value='bottom-right-block' <?php selected( $options['position'], 'bottom-right-block' ); ?>><?php esc_html_e( 'Bottom Right Block', 'uk-cookie-consent' ); ?></option>
            </select>
            <p class="description"><?php esc_html_e( 'Where the notification should appear', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function container_class_render() {
            ...
            <p class="description"><?php esc_html_e( 'You can add an optional wrapper class, eg container, here to align the notification text with the rest of your content', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function enqueue_styles_render() {
            ...
            <p class="description"><?php esc_html_e( 'Deselect this to dequeue the plugin stylesheet', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function rounded_corners_render() {
            ...
            <p class="description"><?php esc_html_e( 'Round the corners on the block (doesn\'t apply to the top or bottom bar)', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function drop_shadow_render() {
            ...
            <p class="description"><?php esc_html_e( 'Add drop shadow to the block (doesn\'t apply to the top or bottom bar)', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function display_accept_with_text_render() {
            ...
            <p class="description"><?php esc_html_e( 'Display the confirmation button with notification text', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function x_close_render() {
            ...
            <p class="description"><?php esc_html_e( 'Remove confirmation button and use \'X\' icon instead', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function text_color_render() {
            ...
            <p class="description"><?php esc_html_e( 'The text color on the notification', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function bg_color_render() {
            ...
            <p class="description"><?php esc_html_e( 'The background color for the notification', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function link_color_render() {
            ...
            <p class="description"><?php esc_html_e( 'The link color on the notification', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function button_color_render() {
            ...
            <p class="description"><?php esc_html_e( 'The text color on the notification button', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function button_bg_color_render() {
            ...
            <p class="description"><?php esc_html_e( 'The background color on the notification button', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function flat_button_render() {
            ...
            <p class="description"><?php esc_html_e( 'Remove the border from the button', 'uk-cookie-consent' ); ?></p>
			<?php
		}
		...
		public function enable_metafield_render() {
            ...
            <p class="description"><?php esc_html_e( 'Select this to enable a metafield on pages and posts. Checking the metafield on a page or post will exclude that page from displaying the notification.', 'uk-cookie-consent' ); ?></p>
			<?php
		}

		public function settings_section_callback() {
			echo '<p>' . esc_html__( 'Basic settings', 'uk-cookie-consent' ) . '</p>';
			echo '<p><a href="https://termly.io/products/privacy-policy-generator/?utm_source=Wordpress%20Plugin&utm_medium=privacy%20policy%20link" target="_blank">' . esc_html__( 'Need a privacy policy? Create one for free with Termly!') . '</a></p>';
		}

		public function content_settings_section_callback() {
			echo '<p>' .esc_html__( 'Update the content displayed to the user', 'uk-cookie-consent' ) . '</p>';
			echo '<p><a href="https://termly.io/products/privacy-policy-generator/?utm_source=Wordpress%20Plugin&utm_medium=privacy%20policy%20link" target="_blank">' . esc_html__( 'Need a privacy policy? Create one for free with Termly!') . '</a></p>';
		}

		public function styles_settings_section_callback() {
			echo '<p>' .esc_html__( 'Change the styles here if you like - but it\'s better in the Customizer', 'uk-cookie-consent' ) . '</p>';
			echo '<p><a href="https://termly.io/products/privacy-policy-generator/?utm_source=Wordpress%20Plugin&utm_medium=privacy%20policy%20link" target="_blank">' . esc_html__( 'Need a privacy policy? Create one for free with Termly!') . '</a></p>';
		}

		public function pages_settings_section_callback() {
			echo '<p>' . esc_html__( 'Use this section to set exclusion rules for pages and posts.', 'uk-cookie-consent' ) . '</p>';
			echo '<p><a href="https://termly.io/products/privacy-policy-generator/?utm_source=Wordpress%20Plugin&utm_medium=privacy%20policy%20link" target="_blank">' . esc_html__( 'Need a privacy policy? Create one for free with Termly!') . '</a></p>';
		}
		...
		public function options_page() {
			...
			// Get the nonce.
			$tab_nonce = filter_input( INPUT_GET, 'tab_nonce', FILTER_SANITIZE_STRING );
			$tab_val   = filter_input( INPUT_GET, 'tab', FILTER_SANITIZE_STRING );
			$current   = ( wp_verify_nonce( $tab_nonce, 'tab_nonce' ) && isset ( $tab_val ) ) ? $tab_val : 'options';
                ...
                <div class="ctdb-outer-wrap">
                    <div class="ctdb-inner-wrap">
                        <h2 class="nav-tab-wrapper">
							...
							foreach ( $tabs as $tab => $name ) {
								...
								$tab_nonce = wp_create_nonce( 'tab_nonce' );
								?>
                                <a class='nav-tab<?php echo esc_attr( $class ); ?>' href='?page=ctcc&tab=<?php echo esc_attr( $tab ); ?>&tab_nonce=<?php echo esc_attr( $tab_nonce ); ?>'>
                        ...
                        <form method="post" action="">
                            <p class="submit">
                                <input name="reset" class="button button-secondary" type="submit" value="<?php esc_attr_e( 'Reset plugin defaults', 'uk-cookie-consent' ); ?>">
                    ...
                    <div class="ctdb-banners">
                        <div class="ctdb-banner">
                            <a href="https://catapultthemes.com/downloads/showcase/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=cookieconsent&utm_campaign=themes"><img src="<?php echo esc_url( CTCC_PLUGIN_URL ) . 'assets/images/showcase-banner-ad.jpg'; ?>" alt=""></a>
                        </div>
                        <div class="ctdb-banner hide-dbpro">
                            <a href="https://discussionboard.pro/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=cookieconsent&utm_campaign=dbpro"><img src="<?php echo esc_url( CTCC_PLUGIN_URL ) . 'assets/images/dbpro-ad-view.png'; ?>" alt=""></a>
                        </div>
                        <div class="ctdb-banner">
                            <a href="https://catapultthemes.com/downloads/sliderify-pro/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=cookieconsent&utm_campaign=themes"><img src="<?php echo esc_url( CTCC_PLUGIN_URL ) . 'assets/images/mgs-banner-ad.png'; ?>" alt=""></a>
                        </div>
                        <div class="ctdb-banner">
                            <a href="http://superheroslider.catapultthemes.com/?utm_source=plugin_ad&utm_medium=wp_plugin&utm_content=cookieconsent&utm_campaign=superhero"><img src="<?php echo esc_url( CTCC_PLUGIN_URL ) . 'assets/images/superhero-ad1.png'; ?>" alt=""></a>
                        </div>
                    </div>
