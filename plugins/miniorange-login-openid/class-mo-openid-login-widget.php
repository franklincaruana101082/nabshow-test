		...
		if ( $theme == 'default' ) {
			if ( $app_name == 'fb' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Facebook'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('facebook','" . $custom_app . "');\"";
					} $html .= "><img alt='Facebook' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/facebook.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'google' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('google','" . $custom_app . "');\"";
					} $html .= " title= ' " . $customTextofTitle . " Google'><img alt='Google' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/google.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'vk' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= "onClick=\"moOpenIdLogin('vkontakte','" . $custom_app . "');\"";
					} $html .= "title= ' " . $customTextofTitle . " Vkontakte'><img alt='Vkontakte' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/vk.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'twitter' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a rel='nofollow'  " . $gdpr_setting . " style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Twitter'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('twitter','" . $custom_app . "');\"";
					} $html .= " ><img alt='Twitter' style=' width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/twitter.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'linkin' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a  rel='nofollow'  " . $gdpr_setting . "style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " LinkedIn'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('linkedin','" . $custom_app . "');\"";
					} $html .= " ><img alt='LinkedIn' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/linkedin.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'insta' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a rel='nofollow'  " . $gdpr_setting . " style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' " . $customTextofTitle . " Instagram'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('instagram','" . $custom_app . "');\"";
					} $html .= " ><img alt='Instagram' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/instagram.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'amazon' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a  rel='nofollow'  " . $gdpr_setting . "style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Amazon' ";
					if ( $app_dis != 'disable' ) {
						$html .= "onClick=\"moOpenIdLogin('amazon','" . $custom_app . "');\"";
					} $html .= " ><img alt='Amazon' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/amazon.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'sforce' ) {
				if ( ! mo_openid_is_customer_registered() ) {
					$app_dis = 'disabled';
				} else {
					$app_dis = '';
				...
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Salesforce'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('salesforce','" . $custom_app . "');\"";
					} $html .= " ><img alt='Salesforce' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/salesforce.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'wlive' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a rel='nofollow'   " . $gdpr_setting . "style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow'  title= ' " . $customTextofTitle . " Microsoft'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('windowslive','" . $custom_app . "');\"";
					} $html .= " ><img alt='Windowslive' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/windowslive.png', __FILE__ ) . "' class='" . $dis . ' login-button ' . $selected_theme . "' ></a>";
				}
				return $html;
			} elseif ( $app_name == 'yahoo' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a  rel='nofollow' " . $gdpr_setting . " style='margin-left: " . $spacebetweenicons . 'px !important;width: ' . $customWidth . ' !important;padding-top:' . ( $customHeight - 29 ) . 'px !important;padding-bottom:' . ( $customHeight - 29 ) . 'px !important;margin-bottom: ' . ( $spacebetweenicons - 5 ) . 'px !important;border-radius: ' . $customBoundary . "px !important;'";
					if ( $view == 'horizontal' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " .
						$customTextofTitle . " Yahoo'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('yaahoo','" . $custom_app . "');\"";
					} $html .= " ><img alt='Yahoo' style='width:" . $customSize . 'px !important;height: ' . $customSize . 'px !important;margin-left: ' . ( $spacebetweenicons ) . "px !important' src='" . plugins_url( 'includes/images/icons/yahoo.png', __FILE__ ) . "' class='login-button " . $selected_theme . "' ></a>";
				}
				return $html;
			}
		} elseif ( $theme == 'custom' ) {
			if ( $app_name == 'fb' ) {
				if ( $selected_theme == 'longbutton' ) {
					$html .= "<a rel='nofollow'   " . $gdpr_setting . '';
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('facebook','" . $custom_app . "');\"";
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('facebook','" . $custom_app . "');\"";
					}$html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-facebook custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'google' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Google'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('google','" . $custom_app . "');\"";
					} $html .= " title= ' " . $customTextofTitle . "  Google'><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-google custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'vk' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Vkontakte'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('vkontakte','" . $custom_app . "');\"";
					} $html .= " title= ' " . $customTextofTitle . "  Vkontakte'><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-vk custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'twitter' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('twitter','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-twitter custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'linkin' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('linkedin','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-linkedin custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				...
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Instagram'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('instagram','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-instagram custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'amazon' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('amazon','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-amazon custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				...
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('salesforce','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-cloud custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'wlive' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('windowslive','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-windows custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			} elseif ( $app_name == 'yahoo' ) {
				if ( $selected_theme == 'longbutton' ) {
					...
					$html .= "<a class='" . $dis . " login-button' rel='nofollow' title= ' " . $customTextofTitle . " Yahoo'";
					if ( $app_dis != 'disable' ) {
						$html .= " onClick=\"moOpenIdLogin('yaahoo','" . $custom_app . "');\"";
					} $html .= " ><i style='margin-top:10px;width:" . $customSize . 'px !important;height:' . $customSize . 'px !important;margin-left:' . ( $spacebetweenicons ) . 'px !important;background:#' . $customBackground . ' !important;font-size: ' . ( $customSize - 16 ) . "px !important;'  class='mofa btn-mo mofa-yahoo custom-login-button  " . $selected_theme . "' ></i></a>";
				}
				return $html;
			}
		}
	...
	if ( isset( $_COOKIE['nab_social_signup_redirect'] ) && ! empty( $_COOKIE['nab_social_signup_redirect'] ) ) {
		...
		if ( isset( $_COOKIE['nab_social_redirect'] ) && ! empty( $_COOKIE['nab_social_redirect'] ) ) {
			...
			if ( empty( $custom_url_redirect ) ) {
				...
				} elseif ( isset( $_POST['checkout_redirect'] ) && ! empty( $_POST['checkout_redirect'] ) ) {
...
function mo_openid_login_validate() {
	...
	if ( isset( $_REQUEST['option'] ) and strpos( $_REQUEST['option'], 'getmosociallogin' ) !== false ) {
	...
	} elseif ( isset( $_POST['mo_openid_connect_register_nonce'] ) and isset( $_POST['option'] ) and $_POST['option'] == 'mo_openid_connect_register_customer' ) {  // register the admin to miniOrange
		...
		mo_pop_show_verify_password_page();
	} elseif ( isset( $_POST['mo_openid_account_linking_nonce'] ) and isset( $_POST['option'] ) and strpos( $_POST['option'], 'mo_openid_account_linking' ) !== false ) {
	...
	} elseif ( isset( $_POST['mo_openid_show_profile_form_nonce'] ) and isset( $_POST['option'] ) and strpos( $_POST['option'], 'mo_openid_show_profile_form' ) !== false ) {
	...
	} elseif ( ( isset( $_POST['action'] ) ) && ( strpos( $_POST['action'], 'delete_social_profile_data' ) !== false ) && isset( $_POST['user_id'] ) ) {
	...
	} elseif ( isset( $_REQUEST['option'] ) and strpos( $_REQUEST['option'], 'oauthredirect' ) !== false ) {
		if ( isset( $_REQUEST['wp_nonce'] ) ) {
			$nonce = sanitize_text_field( $_REQUEST['wp_nonce'] );
	...
	} elseif ( isset( $_POST['mo_openid_connect_verify_nonce'] ) and isset( $_POST['option'] ) and $_POST['option'] == 'mo_openid_connect_verify_customer' ) {    // register the admin to miniOrange
	...
	} elseif ( isset( $_REQUEST['option'] ) and strpos( $_REQUEST['option'], 'moopenid' ) !== false ) {
		mo_openid_process_social_login();
	} elseif ( strpos( $_SERVER['REQUEST_URI'], 'openidcallback' ) !== false || ( ( strpos( $_SERVER['REQUEST_URI'], 'oauth_token' ) !== false ) && ( strpos( $_SERVER['REQUEST_URI'], 'oauth_verifier' ) ) ) ) {
