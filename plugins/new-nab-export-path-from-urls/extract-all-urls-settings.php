...
?>
    ...
    else if ((isset($_REQUEST['del']) && $_REQUEST['del'] == 'y'))
    {
        ...
        {
<<<<<<< HEAD:plugins/nab-export-path-from-urls/extract-all-urls-settings.php
...
>>>>>>> 4f1b89caa547f91b0dee1a52977ee6a18d70492b:plugins/new-nab-export-path-from-urls/extract-all-urls-settings.php
}
