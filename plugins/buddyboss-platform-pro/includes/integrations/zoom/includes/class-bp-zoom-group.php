...
class BP_Zoom_Group {
			...
			<div id="bp-group-zoom-settings" class="bp-group-zoom-settings <?php echo ! $checked ? 'bp-hide' : ''; ?>">
				...
				<div class="bb-field-wrap">
					...
					<div class="bp-input-wrap">
						<input required type="text" name="bp-group-zoom-api-key" id="bp-group-zoom-api-key" class="zoom-group-instructions-main-input" value="<?php echo $api_key; ?>"/>
					</div>
				</div>
				...
				<div class="bb-field-wrap">
					...
					<div class="bp-input-wrap">
						<input required type="text" name="bp-group-zoom-api-secret" id="bp-group-zoom-api-secret" class="zoom-group-instructions-main-input" value="<?php echo $api_secret; ?>"/>
					</div>
				</div>
				...
				<div class="bb-field-wrap">
					...
					<div class="bp-input-wrap">
						<input required type="text" name="bp-group-zoom-api-email" id="bp-group-zoom-api-email" class="zoom-group-instructions-main-input" value="<?php echo $api_email; ?>"/>
					</div>
				</div>
                                    ...
                                    <div id="zoom-instruction-container">
                                        ...
                                        <div class="bb-group-zoom-settings-container">
                                            <div class="bb-field-wrap">
                                                ...
                                                <div class="bp-input-wrap">
                                                    <input required="" type="text" name="bp-group-zoom-api-key-popup" class="zoom-group-instructions-cloned-input" value="<?php echo $api_key; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="bb-field-wrap">
                                                ...
                                                <div class="bp-input-wrap">
                                                    <input required="" type="text" name="bp-group-zoom-api-secret-popup" class="zoom-group-instructions-cloned-input" value="<?php echo $api_secret; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="bb-field-wrap">
                                                ...
                                                <div class="bp-input-wrap">
                                                    <input required="" type="text" name="bp-group-zoom-api-email-popup" class="zoom-group-instructions-cloned-input" value="<?php echo $api_email; ?>" />
                                                </div>
                                            </div>
	...
	public function create_activity( $meeting, $args ) {
		if ( ! empty( $meeting ) && ! empty( $meeting->group_id ) && empty( $args['id'] ) ) {
	...
	public function groups_notification_meeting_created( $meeting, $args ) {
		if ( ! bp_is_active( 'notifications' ) || empty( $meeting ) || empty( $meeting->group_id ) || ! empty( $args['id'] ) ) {
			return;
		}
		...
		if ( ! empty( $zoom_webhook ) && 1 === $zoom_webhook ) {
			...
			if ( ! empty( $group_id ) && 0 < $group_id && bp_zoom_is_group_setup( $group_id ) && ! empty( groups_get_group( $group_id ) ) ) {
				...
				if ( ! empty( $json['event'] ) && ! empty( $json['payload']['object'] ) ) {
					...
					$meeting_response = bp_zoom_meeting_get_specific( array( 'meeting_id' => $zoom_meeting_id ) );
					$meeting          = false;

					if ( ! empty( $meeting_response['meetings'][0] ) ) {
						$meeting = new BP_Zoom_Meeting( $meeting_response['meetings'][0]->id );
                        ...
                        case 'recording.completed':
	                        ...
	                        if ( ! empty( $recording_files ) ) {
		                        foreach ( $recording_files as $recording_file ) {
			                        ...
			                        } elseif ( empty( $recording_id ) && empty( bp_zoom_recording_get( array(), array(
                                        'meeting_id' => $zoom_meeting_id,
                                        'uuid'       => $object['uuid'],
                                        'file_type'  => 'TIMELINE',
                                    ) ) ) ) {
