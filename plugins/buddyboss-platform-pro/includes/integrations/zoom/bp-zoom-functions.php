...
function bp_zoom_enqueue_scripts_and_styles() {
	...
	wp_enqueue_style( 'bp-zoom-meeting', bp_zoom_integration_url( '/assets/css/bp-zoom-meeting' . $min . '.css' ), array(), bb_platform_pro()->version );
...
/**
 * Checks if zoom recordings is enabled.
 *
 * @since 1.0.0
 *
 * @param $default integer
