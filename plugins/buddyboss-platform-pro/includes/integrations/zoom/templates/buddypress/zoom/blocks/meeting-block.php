...
$participants_video     = ! empty( $bp_zoom_meeting_block->settings->participants_video ) ? $bp_zoom_meeting_block->settings->participants_video : false;
...
$mute_participants      = ! empty( $bp_zoom_meeting_block->settings->mute_participants ) ? $bp_zoom_meeting_block->settings->mute_participants : false;
...
$meeting_date       = wp_date( bp_core_date_format( true, true, ' ' ), strtotime( $start_time ) );
...
<div class="zoom-meeting-block">
	...
	if ( ! $recurring ) {
        ...
        <div class="zoom-meeting-block-info">
            <h2 id="bp-zoom-meeting-block-title-<?php echo $meeting_id; ?>"><?php echo $topic; ?></h2>
            ...
            <div id="bp-zoom-block-show-details-popup-<?php echo $meeting_id; ?>"
                ...
                <header class="bb-zm-model-header"><?php echo $topic; ?>
                    <button title="Close (Esc)" type="button" class="mfp-close">×</button></header>
                                ...
                                <div class="copy-link-wrap">
                                    ...
                                    <div id="copy-invitation-popup-<?php echo $meeting_id; ?>"
                                        ...
                                        <header class="bb-zm-model-header"><?php _e( 'View Invitation', 'buddyboss-pro' ); ?>
                                            <a href="#bp-zoom-block-show-details-popup-<?php echo $meeting_id; ?>" class="show-meeting-details" title="<?php _e( 'Close', 'buddyboss-pro' ); ?>"><i class="bb-icon-close"></i><a/>
                                        </header>
        ...
        <div class="zoom-meeting-block-right">
            ...
            if ( bp_zoom_is_zoom_recordings_enabled() && ( $current_date > $meeting_date_unix ) || count( $recordings ) > 1 ) : ?>
                <div id="bp-zoom-meeting-recording-<?php echo $meeting_id; ?>" data-title="<?php echo $topic; ?>" data-meeting-id="<?php echo $meeting_id; ?>" class="bp-zoom-meeting-recording-fetch">
		...
		?>
        <div class="zoom-meeting-block-info buddypress-wrap">
            <aside class="bp-feedback bp-messages bp-template-notice warning">
                <span class="bp-icon" aria-hidden="true"></span>
                <p><?php _e( 'This is a recurring Zoom meeting, which we do not yet support.', 'buddyboss-pro' ); ?> <?php edit_post_link( __( 'Please enter a different meeting ID.', 'buddyboss-pro' ) ); ?></p>
            </aside>
        </div>
		<?php
	}
