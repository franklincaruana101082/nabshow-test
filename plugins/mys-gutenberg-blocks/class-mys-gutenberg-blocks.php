...
if ( ! class_exists('MYSGutenbergBlocks') ) {
    ...
    class MYSGutenbergBlocks {
        ...
        public static function mysgb_add_block_editor_script() {
            ...
            wp_enqueue_script( 'mysgb-gutenberg-block', plugins_url( 'assets/js/blocks/block.build.js', __FILE__ ), array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor', 'wp-components', 'jquery' ), '4.5' );
