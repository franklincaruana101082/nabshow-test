...
(function (wpI18n, wpBlocks, wpElement, wpEditor, wpComponents) {
    ...
    class MYSDynamicSlider extends Component {
        ...
        componentDidUpdate(prevProps) {
            const { clientId, attributes: { minSlides, autoplay, infiniteLoop, pager, controls, sliderSpeed, sliderMode, postType, slideWidth, sliderActive, slideMargin } } = this.props;
            if (sliderActive) {
