...
After you install and activate plugin, all your shop's coupons can be applied by your customers by visiting `http://example.com/?alg_apply_coupon=couponcode`.

You can customize `alg_apply_coupon` key in plugin's settings.
...
* automatically **add coupon's products to the cart** for "Fixed product discount" coupons, and
* set **redirect URL**.
