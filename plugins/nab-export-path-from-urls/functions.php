...
function eau_export_data($urls, $export_type, $csv_name)
{
    ...
    switch ($export_type) {
        case "text":
            ...
            $html .= "<div class='updated' style='width: 97%'>Data exported successfully! <a href='".wp_nonce_url(esc_url($csv_file))."' target='_blank'><strong>Click here</strong></a> to Download.</div>";
