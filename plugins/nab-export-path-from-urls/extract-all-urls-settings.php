...
?>
    ...
    else if ((isset($_REQUEST['del']) && $_REQUEST['del'] == 'y') || (isset($_REQUEST['download']) && $_REQUEST['download'] == 'y'))
    {
        ...
        {
            $checkfile = !empty($_REQUEST['f']) ? base64_decode(sanitize_file_name($_REQUEST['f'])) : null;            
