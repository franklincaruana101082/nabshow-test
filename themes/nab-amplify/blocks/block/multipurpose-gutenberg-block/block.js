    ...
    edit(props) {
      ...
      return [
        <InspectorControls>
          <div className="custom-inspactor-setting">
            <PanelBody title={__("Wrapper")} initialOpen={false}>
              ...
              <Button
                className={
                  "section" === ElementTag ? "button active" : "button"
                }
                onClick={onSelectTagType}
                value="section"
              >
              ...
              >
                ...
                {backgroundImage ? (
                  <Button
                    className="button"
                    onClick={() =>
                      setAttributes({ backgroundImage: "", overlayColor: "" })
                    }
                  >
                  ...
                  <Fragment>
                    ...
                    <div className="inspector-field inspector-border-radius components-base-control">
                      ...
                      <RangeControl
                        ...
                        step={10}
                        onChange={(value) =>
                          setAttributes({ gradientRange1: value })
                        }
                      />
                    </div>
                    ...
                    <div className="inspector-field inspector-border-radius components-base-control">
                      ...
                      <RangeControl
                        ...
                        step={10}
                        onChange={(value) =>
                          setAttributes({ gradientRange2: value })
                        }
                      />
                    </div>
                    ...
                    <div className="inspector-field inspector-border-radius components-base-control">
                      ...
                      <RangeControl
                        ...
                        step={10}
                        onChange={(value) =>
                          setAttributes({ gradientRange3: value })
                        }
                      />
                    </div>
                  </Fragment>
                  ...
                  <div className="inspector-field inspector-border-style">
                    ...
                    <div className="inspector-field-button-list inspector-field-button-list-fluid">
                      <button
                        ...
                        onClick={() => setAttributes({ borderStyle: "solid" })}
                      >
                        <span className="inspector-field-border-type inspector-field-border-type-solid"></span>
                      </button>
                      <button
                        className={
                          "dotted" === borderStyle
                        ...
                        onClick={() => setAttributes({ borderStyle: "dotted" })}
                      >
                        <span className="inspector-field-border-type inspector-field-border-type-dotted"></span>
                      </button>
                      <button
                        className={
                          "dashed" === borderStyle
                        ...
                        onClick={() => setAttributes({ borderStyle: "dashed" })}
                      >
                        <span className="inspector-field-border-type inspector-field-border-type-dashed"></span>
                      </button>
                      <button
                        className={
                          "none" === borderStyle
                        ...
                        onClick={() => setAttributes({ borderStyle: "none" })}
                      >
                        <span className="inspector-field-border-type inspector-field-border-type-none">
                  ...
                  <PanelRow>
                    <div className="inspector-field inspector-border-style">
                      ...
                      <div className="inspector-field-button-list inspector-field-button-list-fluid">
                        <button
                          className={
                            "solid" === topBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ topBorderStyle: "solid" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-solid"></span>
                        </button>
                        <button
                          className={
                            "dotted" === topBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ topBorderStyle: "dotted" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dotted"></span>
                        </button>
                        <button
                          className={
                            "dashed" === topBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ topBorderStyle: "dashed" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dashed"></span>
                        </button>
                      ...
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={10}
                            onChange={(value) =>
                              setAttributes({ topBorderWidth: value })
                            }
                          />
                        </div>
                      </PanelRow>
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={100}
                            onChange={(value) =>
                              setAttributes({ topBorderRadius: value })
                            }
                          />
                        </div>
                      </PanelRow>
                  ...
                  <PanelRow>
                    <div className="inspector-field inspector-border-style">
                      ...
                      <div className="inspector-field-button-list inspector-field-button-list-fluid">
                        <button
                          className={
                            "solid" === rightBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ rightBorderStyle: "solid" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-solid"></span>
                        </button>
                        <button
                          className={
                            "dotted" === rightBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ rightBorderStyle: "dotted" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dotted"></span>
                        </button>
                        <button
                          className={
                            "dashed" === rightBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ rightBorderStyle: "dashed" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dashed"></span>
                        </button>
                      ...
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={10}
                            onChange={(value) =>
                              setAttributes({ rightBorderWidth: value })
                            }
                          />
                        </div>
                      </PanelRow>
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={100}
                            onChange={(value) =>
                              setAttributes({ rightBorderRadius: value })
                            }
                          />
                        </div>
                      </PanelRow>
                  ...
                  <PanelRow>
                    <div className="inspector-field inspector-border-style">
                      ...
                      <div className="inspector-field-button-list inspector-field-button-list-fluid">
                        <button
                          className={
                            "solid" === bottomBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ bottomBorderStyle: "solid" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-solid"></span>
                        </button>
                        <button
                          className={
                            "dotted" === bottomBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ bottomBorderStyle: "dotted" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dotted"></span>
                        </button>
                        <button
                          className={
                            "dashed" === bottomBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ bottomBorderStyle: "dashed" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dashed"></span>
                        </button>
                      ...
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={10}
                            onChange={(value) =>
                              setAttributes({ bottomBorderWidth: value })
                            }
                          />
                        </div>
                      </PanelRow>
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={100}
                            onChange={(value) =>
                              setAttributes({ bottomBorderRadius: value })
                            }
                          />
                        </div>
                      </PanelRow>
                  ...
                  <PanelRow>
                    <div className="inspector-field inspector-border-style">
                      ...
                      <div className="inspector-field-button-list inspector-field-button-list-fluid">
                        <button
                          className={
                            "solid" === leftBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ leftBorderStyle: "solid" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-solid"></span>
                        </button>
                        <button
                          className={
                            "dotted" === leftBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ leftBorderStyle: "dotted" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dotted"></span>
                        </button>
                        <button
                          className={
                            "dashed" === leftBorderStyle
                              ? "active inspector-button"
                              : " inspector-button"
                          }
                          onClick={() =>
                            setAttributes({ leftBorderStyle: "dashed" })
                          }
                        >
                          <span className="inspector-field-border-type inspector-field-border-type-dashed"></span>
                        </button>
                      ...
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={10}
                            onChange={(value) =>
                              setAttributes({ leftBorderWidth: value })
                            }
                          />
                        </div>
                      </PanelRow>
                      <PanelRow>
                        <div className="inspector-field inspector-border-width">
                          ...
                          <RangeControl
                            ...
                            max={100}
                            onChange={(value) =>
                              setAttributes({ leftBorderRadius: value })
                            }
                          />
                        </div>
                      </PanelRow>
                ...
                <div className="inspector-field inspector-field-transform">
                  ...
                  <div className="inspector-field-button-list inspector-field-button-list-fluid inspector-ml-auto">
                    <button
                      ...
                      onClick={() => setAttributes({ blockAlign: "none" })}
                    >
                      <i className="fa fa-ban"></i>
                    </button>
                    <button
                      className={
                        "lowercase" === blockAlign
                          ? "active inspector-button"
                          : " inspector-button"
                      }
                      onClick={() => setAttributes({ blockAlign: "lowercase" })}
                    >
                      <span>aa</span>
                    </button>
                    <button
                      className={
                        "capitalize" === blockAlign
                          ? "active inspector-button"
                          : " inspector-button"
                      }
                      onClick={() =>
                        setAttributes({ blockAlign: "capitalize" })
                      }
                    >
                      <span>Aa</span>
                    </button>
                    <button
                      className={
                        "uppercase" === blockAlign
                          ? "active inspector-button"
                          : " inspector-button"
                      }
                      onClick={() => setAttributes({ blockAlign: "uppercase" })}
                    >
                      <span>AA</span>
                    </button>
                  </div>
        ...
        <ElementTag
          id={elementID}
          className={`${classes} ${
            ToggleInserter ? "md-inserter-on" : "md-inserter-off"
          }`}
          style={style}
        >
          <InnerBlocks />
