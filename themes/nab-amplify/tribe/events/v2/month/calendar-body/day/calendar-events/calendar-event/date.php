...
$display_start_date = $event->dates->start_display->format( $time_format );
$display_start_date = str_replace( ':00 ', '', $display_start_date );
...
<div class="tribe-events-calendar-month__calendar-event-datetime">
    ...
    <time datetime="<?php echo esc_attr( $event->dates->start_display->format( $time_format ) ); ?>">
		<?php echo esc_html( $display_start_date ); ?>
    </time>
	<?php if ( $display_end_date ) :
		$display_end_date = $event->dates->end_display->format( $time_format );
		$display_end_date = str_replace( ':00 ', ' ', $display_end_date );
		?>
