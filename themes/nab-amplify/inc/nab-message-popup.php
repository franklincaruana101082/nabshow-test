...
<div id="connection-message-popup" class="nab-modal" data-comp-admin-id="<?php echo $company_admin_id[0]; ?>">
                ...
                <form method="post" id="connection-message-form">
                    ...
                    <div class="author-info">
                        <div class="author-image">
                            <a href="<?php echo bp_core_get_user_domain($company_admin_id[0]); ?>"><img src="<?php echo esc_url($user_images['profile_picture']) ?>" /></a>
                        </div>
                        <div class="author-details">
                            <h3 class="author-title"><a href="<?php echo bp_core_get_user_domain($company_admin_id[0]); ?>"><?php echo get_the_author_meta('user_nicename', $company_admin_id[0]); ?></a></h3>
