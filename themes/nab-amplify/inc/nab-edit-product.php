                    ...
                    <div class="form-wrapper">
                        <form method="post" id="nab-edit-product-form" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <input type="text" required="true" class="input-text add-product" name="nab_product_title" value="<?php echo isset( $post_data->post_title ) ? esc_attr( $post_data->post_title ) : ''; ?>" id="product_title">
                                ...
                                <div class="select-dark-simple select-multiple">
                                    <select name="product_categories[]" multiple="true" id="product_categories">
										...
										<?php foreach ( $terms as $p_term ) {
											?>
                                            <option value="<?php echo esc_attr( $p_term->slug ); ?>" <?php if ( in_array( $p_term->slug, $post_data->categories ) ) {
												echo "selected";
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-control">
                                    <div class="file-input bm-select-media" bynder-for="product_media_bm"><input type="file" data-media-count="<?php echo esc_attr( $existing_media_count ); ?>" id="product_medias" class="button" name="product_medias[]" multiple>
									...
									foreach ( $post_data->product_media as $media ) {
										if ( ! empty( $media['product_media_file'] ) ) {
                                            ...
                                            <div class="nab-product-media-item">
                                                <button type="button" class="nab-remove-attachment" data-attach-id="<?php echo esc_attr( $media['product_media_file']['ID'] ); ?>"><i class="fa fa-times" aria-hidden="true"></i></button>
												<?php if ( $media['product_media_file']['type'] === 'image' ) { ?>
                                                    <img src="<?php echo esc_url( $media['product_media_file']['url'] ); ?>"/>
												<?php }
												if ( $media['product_media_file']['type'] !== 'image' ) {
													?>
                                                    <span><?php echo esc_html( $media['product_media_file']['title'] ); ?></span>
													<?php
												} ?>
                                            </div>
											<?php
                            ...
                            <div class="form-row">
                                ...
                                <textarea name="nab_product_copy" id="nab_product_copy"><?php echo isset( $post_data->product_copy ) ? esc_attr( $post_data->product_copy ) : ''; ?></textarea>
                            ...
                            <div class="form-row">
                                <div class="form-col-6">
                                    <div class="form-row">
                                        ...
                                        <textarea name="nab_product_specs" id="nab_product_specs"><?php echo isset( $post_data->product_specs ) ? esc_attr( $post_data->product_specs ) : ''; ?></textarea>
                                ...
                                <div class="form-col-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="input-text add-tags" name="nab_product_tags" id="nab_product_tags" value="<?php if ( $post_data->tags ) {
											echo esc_attr( implode( ',', $post_data->tags ) );
										} ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <input type="text" class="input-text learn-more-url" name="nab_product_learn_more_url" id="nab_product_learn_more_url" value="<?php echo isset( $post_data->nab_product_learn_more_url ) ? esc_attr( $post_data->nab_product_learn_more_url ) : ''; ?>">
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
								...
								?>
                                <input type="hidden" name="nab_product_id" id="nab_product_id" value="<?php echo isset( $post_data->ID ) ? esc_attr( $post_data->ID ) : 0 ?>"/>
