...
add_action( 'init', 'nab_create_user_reaction_table' );

/**
 * Create Database table for user reactions.
 */
function nab_create_user_reaction_table() {
 ...
 */
function nab_get_reaction_buttons( $post_id, $item_type = 'post_type' ) {
 ...
 * @param  mixed $post_id
 */
function nab_get_reacted_item_list( $post_id ) {
 ...
 */
function nab_get_user_reaction( $user_id, $post_id ) {
 ...
 * @return int
 */
function nab_get_total_reactions( $post_id ) {
 ...
 */
function nab_remove_reaction( $user_id, $post_id ) {
...
// User reaction ajax
add_action( 'wp_ajax_nab_update_post_reaction', 'nab_update_post_reaction_callback' );
add_action( 'wp_ajax_nopriv_nab_update_post_reaction', 'nab_update_post_reaction_callback' );

/**
 * User reaction ajax to handle add, update or delete reaction based on user activity.
 */
function nab_update_post_reaction_callback() {
...
add_shortcode( 'reaction_button', 'nab_display_reaction_button_callback' );
 ...
 * @return string
 */
function nab_display_reaction_button_callback( $atts ) {
...
function get_individual_reaction_count( $post_id, $reaction_id ) {
	global $wpdb;
