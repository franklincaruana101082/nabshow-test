					...
					<div class="form-wrapper">
						<form method="post" id="nab-add-edit-pdf-form" enctype="multipart/form-data">
							...
							<div class="form-row" id="pdf_media_wrapper">
								...
								if ( isset( $post_data->ID ) && has_post_thumbnail( $post_data->ID ) ) {
									...
									<div class="nab-pdf-media-item">
										<i class="fa fa-times remove-featred-img" aria-hidden="true"></i>
							...
							<div class="form-row">
								...
								<textarea name="pdf_desc" id="pdf-description" maxlength="200"><?php echo isset($post_data->product_copy)?$post_data->product_copy:''; ?></textarea>
