...
<div class="author">
    <div class="author__photo">
        <a href="<?php echo esc_url( $author_link ); ?>">
			...
			<?php } else { ?>
                <div class="author__noimg no-image-avtar"><?php echo esc_html( mb_strimwidth( $author_full_name, 0, 20, '...' ) ); ?></div>
			<?php } ?>
        </a>
    </div>
