<?php
$member_level = '';
if ( isset( $company_data['ID'] ) && ! empty( $company_data['ID'] ) && 0 !== (int) $company_data['ID'] ) {
                        ...
                        <form method="post" id="nab-edit-company-profile-form" enctype="multipart/form-data">
                            <div class="company-about-row">
                                <div class="form-row">
                                    ...
                                    <textarea class="input-text limited-char-field" name="company_about" id="company_about"><?php echo isset( $company_data['company_about'] ) ? esc_html ( $company_data['company_about'] ) : ''; ?></textarea>
                            ...
                            <div class="company-info-row">
                                <div class="form-row">
                                    ...
                                    <input type="text" class="input-text" name="company_industry" value="<?php echo isset( $company_data['company_industry'] ) ? esc_attr( $company_data['company_industry'] ) : ''; ?>" id="company_industry">
                                </div>
                                <div class="form-row">
                                    <label for="">Website</label>
                                    <input type="text" class="input-text" name="company_website" value="<?php echo isset( $company_data['company_website'] ) ? esc_attr( $company_data['company_website'] ) : ''; ?>" id="company_website">
                                </div>
								<?php
