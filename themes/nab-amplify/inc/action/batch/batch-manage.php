...
<div class="batch-process">
	...
	<form class="companies-export-form" method="post" enctype="multipart/form-data">
            <input type="file" name="import_csv" id="nab_import_company"/>
        </form>
		<ul class="batch-process-stats">
			<li><strong>Total:</strong> <span id="batch-process-total"><?php echo '0'; ?></span></li>
			<li><strong>Processed:</strong> <span id="batch-process-processed"><?php echo '0'; ?></span> <span id="batch-process-percentage">(<?php echo '0'; ?>%)</span></li>
		</ul>
		<div class="batch-process-progress-bar">
			<?php
			$style = $percentage > 0 ? 'width:'.$percentage.'%' : '';
			?>
			<div class="batch-process-progress-bar-inner" style="<?php echo '0'; ?>"></div>
		</div>
