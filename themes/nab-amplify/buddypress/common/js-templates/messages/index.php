...
<script type="text/html" id="tmpl-bp-messages-form">
    ...
    <div class="submit">
        ...
        <input type="button" id="bp-messages-reset" class="text-button bp-reset-button small bp-secondary-action" value="<?php echo esc_attr_x( 'Reset', 'form reset button', 'buddypress' ); ?>"/>
    </div>
</script>
    ...
    <form id="send-reply" class="standard-form send-reply">
        <div class="message-box">
            ...
            <div class="message-content">
                ...
                <div class="submit">
                    <input type="submit" name="send" value="<?php echo esc_attr_x( 'Send Reply', 'button', 'buddypress' ); ?>" id="send_reply_button" class="button"/>
                </div>
