        ...
        success: function (response) {
            ...
            if ( followObj.success ) {
                ...
                if ( 'follow' === _this.attr('data-action') ) {
                    ...
                    _this.parents('.amp-profile-content').find('.amp-profile-image label').append(followObj.unfollow_btn);
                    _this.parents('.search-actions').replaceWith(followObj.message_btn);
                    

                } else if( 'unfollow' === _this.attr('data-action') ) {

                    _this.parents('.amp-profile-content').find('.amp-actions .search-actions').replaceWith(followObj.follow_btn);
