...
function nabshow_lv_2021_register_custom_script() {
    ...
    wp_enqueue_script( 'nabshow-lv-2021-custom', '/wp-content/themes/nabshow-lv-child-2021/assets/js/nabshow-lv-2021.js', array( 'jquery' ) );
                ...
                <div class="filter-row">
                        ...
                        <div class="filter-column-sticky">
                            ...
                            <div class="filter-settings-wrap">
                                ...
                                <div class="filter-item-dropdowns">
                                    ...
                                    <?php
                                    $filter_programs = get_terms( array(
                                            'taxonomy' => 'tracks'
                                        )
                                    );

                                    if ( ! empty( $filter_programs ) && ! is_wp_error( $filter_programs ) ){
                                        ...
                                        <div class="filter-dropdown">
                                            <select class="filter-program">
                                                ...
                                                <?php
                                                foreach ( $filter_programs as $current_program ) {
                                                    ?>
                    ...
                    <div class="filter-column" id="mys-session-list">
                        ...
                        <div class="filter-result-wrap">
                            <?php
                            $session_list = new WP_Query(array(
                                    'post_type'      => 'mys-sessions',
                                    'posts_per_page' => 10,
                                )
                            );
                            $total_pages    = $session_list->max_num_pages;
                            if ( $session_list->have_posts() ) {
                                ...
                                while ( $session_list->have_posts() ) {

                                    $session_list->the_post();
