...
function nabshow_lv_scripts() {
    ...
    wp_enqueue_script( 'nabshow-lv-custom', get_template_directory_uri() . '/assets/js/nabshow-lv.js', array( 'jquery' ), '6.4.5', true );
	...
	//Marketo script
	wp_enqueue_script( 'nabshow-lv-marketo', UrlVerifier::AppendTimeToUrl('//app-ab34.marketo.com/js/forms2/js/forms2.min.js'), array( 'nabshow-lv-custom' ), null, true );
