...
function nabshow_lv_scripts() {
    ...
    wp_enqueue_style( 'nabshow-lv-custom-style', get_template_directory_uri() . '/assets/css/custom.css', array(), '5.9' );

    wp_enqueue_style( 'nabshow-lv-media-style', get_template_directory_uri() . '/assets/css/media.css', array(), '5.9' );
    ...
    wp_enqueue_script( 'nabshow-lv-iframe-resize', get_template_directory_uri() . '/assets/js/iframeResizer.min.js', array( 'jquery' ), '5.8', true );
    wp_enqueue_script( 'nabshow-lv-custom', get_template_directory_uri() . '/assets/js/nabshow-lv.js', array( 'jquery' ), '5.8', true );
