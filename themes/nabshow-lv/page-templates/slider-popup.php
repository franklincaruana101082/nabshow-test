...
$plannerlink = filter_input( INPUT_GET, 'plannerlink', FILTER_SANITIZE_STRING );
$plannerlink = str_replace( '/', '', $plannerlink ); //removing extra slash generated by 301 redirect.
					...
					if ( "speakers" === $current_type ) {
                        ...
                        <div class="modal-popup-nab-inner">
								...
								if ( $session_query->have_posts() ) {
                                    ...
                                    <ul class="session-list">
										...
										while ( $session_query->have_posts() ) {
                                            ...
                                            <li class="item">
                                                <div class="inner">
                                                    <h4 class="title"><a href="#" class="modal-detail-list-modal-popup" data-postid="<?php echo esc_attr( $speaker_session_id ); ?>" data-posttype="sessions" data-plannerlink="<?php echo esc_attr($plannerlink) ?>"><?php echo esc_html( mb_strimwidth( get_the_title(), 0, 83, '...' ) ); ?></a></h4>
													<?php
                                                    if ( ! empty( $sub_title ) ) {
													?>
                            ...
                            <div class="popup-bottom">
	                            <?php
	                            if ( ! empty( $speaker_id ) && "true" === $plannerlink ) {
	                                ?>
		                            <div class="view-btn">
                                    ...
                                    <ul class="speakers-list">
										...
										while ( $speaker_query->have_posts() ) {
                                            ...
                                            <li>
                                                ...
                                                <div class="details">
                                                    <h4 class="title"><a href="#" class="modal-detail-list-modal-popup" data-postid="<?php echo esc_attr( $session_speaker_id ); ?>" data-posttype="speakers" data-plannerlink="<?php echo esc_attr($plannerlink) ?>"><?php echo esc_html( $speaker_name ); ?></a></h4>
