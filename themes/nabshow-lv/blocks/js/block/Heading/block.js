				...
				<Fragment>
					...
					<InspectorControls>
						<PanelBody title="Heading" initialOpen={true}>
							<PanelRow>
								<div class="inspector-field inspector-field-headings">
									<div class="inspector-field-button-list inspector-field-button-list-fluid">
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h1' })}>
											<svg width="17" height="13" viewBox="0 0 17 13" xmlns="http://www.w3.org/2000/svg">
												<g class="inspector-svg-fill" fill-rule="nonzero">
										...
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h2' })}>
										...
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h3' })}>
										...
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h4' })}>
											<svg width="19" height="13" viewBox="0 0 19 13" xmlns="http://www.w3.org/2000/svg">
												<g class="inspector-svg-fill" fill-rule="nonzero">
													<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z"></path>
										...
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h5' })}>
											<svg width="19" height="14" viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg">
												<g class="inspector-svg-fill" fill-rule="nonzero">
													<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z"></path>
										...
										<button class=" inspector-button" onClick={() => setAttributes({ HeadingLevel: 'h6' })}>
											<svg width="19" height="14" viewBox="0 0 19 14" xmlns="http://www.w3.org/2000/svg">
												<g class="inspector-svg-fill" fill-rule="nonzero">
													<path d="M10.83 13h-2.109v-5.792h-5.924v5.792h-2.101v-12.85h2.101v5.256h5.924v-5.256h2.109z"></path>
						...
						<PanelBody title="Typography" initialOpen={false}>
							...
							<PanelRow>
								<div class="inspector-field inspector-field-fontfamily side-2-col">
									<div class="inspector-letter-spacing">
