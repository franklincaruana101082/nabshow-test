...
function nabshow_base_enqueue_styles() {
    ...
    wp_enqueue_style( 'nabshow-ny2022', 
    ...
    wp_enqueue_script( 'nabshow-ny2022-slick', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', array(), '1.8.1', true);

    wp_enqueue_script( 'nabshow-ny2022-main', get_template_directory_uri() . '/assets/js/app.min.js', array(), '1.0', true );
    wp_enqueue_script( 'nabshow-ny2022-gleanin-plugin', 'https://app.webreg.me/communities/076497845fd7/engagements.js', array(), '1.0', true );
