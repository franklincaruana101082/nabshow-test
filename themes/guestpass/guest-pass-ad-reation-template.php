...
function textToImage(
  ...
  $pad=5,
  $font='https://nabshow.com/fonts/Arial-BoldMT.otf'
){
...
&& $imageFileType != "gif")) {
    ...
    foreach ($ad_options as $ad) {
    	// Create Booth number image
			$booth_image = textToImage($_POST['booth'], $ad['booth_size'],$ad['color'],$ad['color'],$ad['padding'],get_template_directory_uri() . '/fonts/Arial-BoldMT.otf');

    	// Create Code image
			$code_image = textToImage($_POST['code'], $ad['code_size'],$ad['color'],$ad['color'],$ad['padding']/2,get_template_directory_uri() . '/fonts/OpenSans.ttf');
