...
if ( have_rows( 'featured_topics' ) ) : 
  ...
  <div class="section topics">
	...
	<ul class="topics__nav">
		<?php
		while ( have_rows( 'featured_topics' ) ) :
			the_row();
			?>
...
if ( have_rows( 'closing_featurette' ) ) :
	while ( have_rows( 'closing_featurette' ) ) :
		the_row();
		  ...
		  <li class="featurette__item">
			...
			<?php endif; ?>
			  ...
			  <div class="featurette__itemcontent">
				...
				<div class="featurette__linktext">
					<?php 
					if ( ! empty( $featurette_link ) ) {
						echo( $featurette_link['title'] );} 
					?>
				</div>
			  </div>
					<?php if ( ! empty( $featurette_link ) ) : ?>
